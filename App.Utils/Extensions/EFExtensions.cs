...
namespace App.Utils.Extensions
{
    public static class EFExtensions
    {
        ...
        /// <returns></returns>
        public static DbCommand LoadStoredProc(this DbContext context, string storedProcName, bool prependDefaultSchema = true, short commandTimeout = 30, bool isCreateNewConnection = false)
        {
